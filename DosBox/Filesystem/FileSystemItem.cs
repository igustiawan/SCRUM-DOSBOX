...
namespace DosBox.Filesystem
{
    ...
    public abstract class FileSystemItem
    {
        ...
        private string timeStamp; //deklarasi variabel timestamp
       

        private Directory parent;

        protected FileSystemItem(string itemName, Directory parent, string timeStamp) // ad variabel lemparan timestamp
        {
            if (parent == null && timeStamp == null)
            {
            }
            else
            {
            ...
            this.parent = parent;
            this.timeStamp = timeStamp; //tampung ke timestamp
        ...
        //create return timestamp buat dipanggil di CmdDir
